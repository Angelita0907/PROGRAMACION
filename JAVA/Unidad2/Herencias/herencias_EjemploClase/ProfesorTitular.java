...
public class ProfesorTitular extends Profesor {
	...
	public String toString() {
		return "ProfesorTitular [fechaAdjudicacionPlaza=" + fechaAdjudicacionPlaza + ", dni=" + getDni() + ", nombre="
				+ getNombre() + ", apellidos=" + getApellidos() + ", getNombreDepartamento()=" + getNombreDepartamento()
				+ ", getNombre()=" + getNombre() + "]";
	}
